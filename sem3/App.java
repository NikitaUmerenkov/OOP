...
import sem3.StudentDomen.Student;
import sem3.StudentDomen.StudentGroup;
import sem3.StudentDomen.StudentStream;
import sem3.StudentDomen.User;
...
public class App {
	public static void main(String[] args) throws Exception {
		...
		Student s7 = new Student("Student07", "StuLastName07", 8, (long) 667);
		Student s8 = new Student("Student08", "StuLastName08", 8, (long) 787);
		Student s9 = new Student("Student09", "StuLastName09", 9, (long) 877);
		...
		// Создание потока студентов с именем "MSI"
		StudentStream lomonosov = new StudentStream("MSI", 1);
		// Наполнение потока
